...
@section('content-header')
  <div class="row align-items-center">
		...
		<div class="col-md-auto">
        	<a href="{{ route('dashboard.admin.posts.table') }}" class="btn btn-block btn-lg btn-primary">Olah Post</a>
        </div>
  </div>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="carousel-inner">
                            @foreach ($headlines as $i => $headline)
                                    ...
                                    <div class="carousel-item {{ $i === 0 ? 'active' : '' }}">
                                        ...
                                        <a class="text-white" href="{{ route('dashboard.admin.posts.show', $headline->slug) }}">
                    ...
                    @foreach ($posts as $post)
                        <a href="{{ route('dashboard.admin.posts.show', $post->slug) }}">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xl-4">
        ...
        <div class="col-lg-4"> {{-- right section --}}
            <div class="card">
                <div class="card-body px-3">
                    ...
                    <a href="{{ route('dashboard.admin.posts.show', $post) }}">
                        <div class="card mb-2">
                            <div class="card-body p-3">
                                <div class="row gutters-xs">
                                    ...
                                    <div class="col-xl pl-2">
                                        <div class="tx-12 mb-2 font-weight-bold">{{ substr(strip_tags($post->title), 0, 50).( (strlen(strip_tags($post->title)) > 50) ? '...' : ''  ) }}</div>
