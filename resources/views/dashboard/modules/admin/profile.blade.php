...
<div class="row justify-content-center">
    <div class="col-md-auto">
        <div class="card">
            <div class="card-body">
                <div id="img-card">
                    <img src="{{ asset('storage/'.$admin->photo) }}" class="img-fluid" id="img-user">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea 
                        name="bio"
                        class="form-control" style="min-height: 100px">{{ old('bio') ? old('bio') : $admin->bio }}</textarea>
                </div>
                <div class="form-group">
                    <label for="">Alamat Saat Ini</label>
                    <div class="card bg-light shadow-none">
                        <div class="card-body">
                            {{ $admin->detail_address }}, 
                            {{ $admin->kelurahan }} - 
                            {{ $admin->kecamatan }} - 
                            {{ $admin->kabupaten }} - 
                            {{ $admin->provinsi }}
