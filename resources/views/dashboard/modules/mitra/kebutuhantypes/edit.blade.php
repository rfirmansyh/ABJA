...
@section('content-header')
  <div class="row align-items-center">
        <div class="col-md"><h2 class="section-title">Form Ubah Kebutuhan Produksi Saya</h2></div>
...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <form action="{{ route('dashboard.mitra.kebutuhantypes.update', $kebutuhanType->id) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                <div class="form-group">
                    ...
                    <input 
                        type="text" 
                        name="name"
                        value="{{ old('name') ? old('name') : $kebutuhanType->name }}"
                ...
                <div class="form-group">
                    ...
                    <input 
                        type="text" 
                        name="unit"
                        value="{{ old('unit') ? old('unit') : $kebutuhanType->unit }}"
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea 
                        name="description" 
                        class="form-control" 
                        style="min-height: 100px">{{ old('description') ? old('description') : $kebutuhanType->description }}</textarea>
                </div>
